...
COUNT_BASED_FOODS = {
    ...
    "snickers": {"calories_per_unit": 250, "protein_per_unit": 5.0, "unit_name": "bar"},
...
def parse_weight_quantity(quantity_query: str) -> float:
    ...
    if not m:
        raise ValueError("Quantity input should be like: 20 g, 1.5 oz, 2 kg or just 2 for count foods")
...
if submitted:
    ...
    if all_results:
        ...
        st.subheader("Calories and Protein Pie Chart")
